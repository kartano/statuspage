...
final class Incident
{
    ...
    public function __construct(array $incident, Statuspage $parent)
    {
        ...
        $this->created_at = Util::safeDateTime($incident['created_at']);
        $this->updated_at = Util::safeDateTime($incident['updated_at']);
        $this->monitoring_at = Util::safeDateTime($incident['monitoring_at']);
        $this->resolved_at = Util::safeDateTime($incident['resolved_at']);
        $this->impact = $incident['impact'];
        $this->shortlink = $incident['shortlink'];
        $this->started_at = Util::safeDateTime($incident['started_at']);
